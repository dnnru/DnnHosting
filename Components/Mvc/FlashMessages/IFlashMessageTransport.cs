...
namespace Italliance.Modules.DnnHosting.Components.Mvc.FlashMessages
{
    ...
    public interface IFlashMessageTransport
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Difference from Peek() is that these are the messages queued in the current response, while Peek() and
        ///     Retrieve() deal with messages which were queued in the previous response.
        /// </remarks>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns>
        ///     A string containing the serialized flash messages, or and empty string in case not flash messages are
        ///     available.
        /// </returns>
