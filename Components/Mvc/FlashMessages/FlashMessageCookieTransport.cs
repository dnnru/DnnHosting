...
{
    /// <summary>
    ///     Transports flash messages using a cookie. Flash messages are signed using the configured machine key in order to
    ///     prevent tampering with them.
    /// </summary>
    public class FlashMessageCookieTransport : IFlashMessageTransport
    {
        ...
        /// <summary>
        ///     Gets / sets the size limit of the cookie in bytes. This is used to ensure the response complies with the cookie
        ///     specification. Set to zero to disable.
        /// </summary>
        ...
        public void Queue(IList<FlashMessageModel> messages)
        {
            ...
            var data = Convert.ToBase64String(MachineKey.Protect(serializedMessages));
        ...
        public List<FlashMessageModel> GetQueued()
        {
            ...
            var serializedMessages = MachineKey.Unprotect(Convert.FromBase64String(cookie.Value));
        ...
        public List<FlashMessageModel> Retrieve()
        {
            ...
            // Decode and deserialize the data.
            var serializedMessages = MachineKey.Unprotect(Convert.FromBase64String(data));
            return FlashMessage.Deserialize(serializedMessages);
        }
