...
namespace Italliance.Modules.DnnHosting.Components.ExcelDataExtractor
{
        ...
        where TCollectionItem : class, new()
    {
        ...
        /// header row specified in the <see cref="ICollectionPropertyConfiguration.WithCollectionProperty{TCollectionItem}(Expression{Func{TRow, Collection{TCollectionItem}}}, int, string, Action{IColumnToCollectionConfiguration{TCollectionItem}})"/>
        /// </param>
