...
namespace Italliance.Modules.DnnHosting.Components.ExcelDataExtractor
{
    ...
    public interface IDataExtractor<TRow> where TRow : class, new()
    {
        /// <summary>
    ...
    public interface IGetData<TRow> where TRow : class, new()
    {
        /// <summary>
        ...
        ///     the following rows will be read until the
        ///     <param name="while" />
        ///     returns false,
    ...
    public interface IConfiguredDataExtractor<TRow> : IDataExtractor<TRow>, IGetData<TRow> where TRow : class, new()
    { }
}